import figmaSustainableMode from '../assets/case-studies/figma-sustainable-mode.png'
import orbit from '../assets/case-studies/orbit.png'
      ...
      <div className="grid w-full grid-cols-1 gap-3 @[2000px]/studies:grid-cols-2">
        {caseStudies.map((caseStudy) => (
          <CaseStudyCard
            ...
            {...caseStudy}
            onOpen={
              caseStudy.title === 'Figma Sustainable Mode'
                ? () => onProjectOpen?.('figma')
                : caseStudy.title === 'Orbit'
                  ? () => onProjectOpen?.('orbit')
                  : caseStudy.title === 'UrbanProjective'
                    ? () => onProjectOpen?.('urban')
                    : undefined
            }
          />
